                    ...
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td>Protect vlan</td>
                                <td>
                                    <select id="selProtect" title="protect vlan" class="mySelect">
        ...
        function loadPage() {
            ...
            if (vCount > 0) {
                ...
                for (let i = 0; i < vCount; i++) {
                    ...
                    html += ('<option value="' + vlanSet[i] + '">' + vlanSet[i] + '</option>');
                }
            ...
            if (dCount > 0) {
                ...
                for (let i = 0; i < dCount; i++) {
                    ...
                    if (dataset[i][2]) {
                        html += ('<button type="button" style="margin-left:10%;" class="btn btn-primary" disabled="disabled" myid=' + dataset[i][0] + ' myname=' + dataset[i][1] + '  name="btnEnable">使能</button>');
                        html += ('<button type="button" style="margin-left:10%;" class="btn btn-primary" myid=' + dataset[i][0] + ' myname=' + dataset[i][1] + '  name="btnDisable">不使能</button>');
                    }
                    else {
                        html += ('<button type="button" style="margin-left:10%;" class="btn btn-primary" myid=' + dataset[i][0] + ' myname=' + dataset[i][1] + '  name="btnEnable">使能</button>');
                        html += ('<button type="button" style="margin-left:10%;" class="btn btn-primary" disabled="disabled" myid=' + dataset[i][0] + ' myname=' + dataset[i][1] + '  name="btnDisable">不使能</button>');
                    }
                    html += ('</td>');
                    html += ('</tr>');
                }
